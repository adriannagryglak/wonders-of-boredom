...
export default function CreateActivityDisplay() {
  ...
  let scrollStart = useMediaPredicate("(min-width: 30rem)")
    ? "-50% 50%"
    : "-10% 50%";
  ...
  return (
    <CreateActivityLinkWrapperStyled ref={linkWrapperRef} id="create-display">
      <p>
        Feel free to share your personal best ideas on how to fight boredom,
        maybe you'll inspire someone too.
      </p>
